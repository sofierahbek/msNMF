...
% Monotonous slope NMF: Z=W*H with W being basis functions constrained to be monotonous and have monotonous slope.
...
% Function created by Sofie Rahbek. Date: 03/07/20/, revised 09/07/21.
...
% Winit: initialization of W [n x s]. Default: all values set to 0.1.
